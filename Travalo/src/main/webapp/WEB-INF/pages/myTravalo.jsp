...
<!--<form:form method="post" id="myProfileForm" action="register/add" commandName="user">-->
        <div id="myProfilePic">
           <!-- <input id="input-dim-1" type="file" multiple class="file-loading" accept="image/*">-->
            <img src="<c:url value='${user.imagePath}'/>"/>
            <h3>${user.login}</h3>
        </div>
        ...
        <div id="myProfileButtons">
                <a id="changePhoto" data-toggle="modal" href="#profileImageModal" class="btn btn-primary btn-large"><spring:message code="label.uploadNewPhoto"/></a>
